...
### `boilerplate` 1.4.0 Published on CRAN

**12 July 2026 | Comprehensive R Archive Network**

Version 1.4.0 of the [`boilerplate` R package](https://cran.r-project.org/package=boilerplate) was published on the Comprehensive R Archive Network (CRAN). The package supports reproducible management of standardised methods, results, measures, and report templates.

Version 1.4.0 makes JSON the default database format and removes RDS writing from package APIs. Existing trusted RDS databases remain readable and can be converted with `boilerplate_migrate_to_json()`.

---

### New Master's and Honours Students Join OTTO Lab

**July 2026 | Victoria University of Wellington**

We are delighted to welcome two new students to OTTO Lab: Purti Pristine and Christina Cartwright.

Purti joins the lab from Indonesia as a Master's student. She is estimating the long-term causal effects of belief in God and belief in a spirit or life force on multidimensional well-being, asking whether joint belief yields synergistic benefits.

Christina joins the lab as an Honours student. Originally from Austria, she brings extensive experience in government. She is estimating heterogeneous effects of volunteering: how its effects on different aspects of well-being vary across groups. She uses causal forests and policy trees.

A warm welcome to Purti and Christina.
...
Victor Counted, Maureen Miner, and Joseph Bulbulia have published *Australia and New Zealand: The psychology of religion up to 2020* in *The Cambridge Handbook of the International Psychology of Religion*. [DOI](https://doi.org/10.1017/9781108771122.003)
...
The Places Map project is now live at [religionmap.org](https://religionmap.org/). Places Map is open research infrastructure for mapping places of worship and supporting cross-cultural policy research.
...
Mohammad joins the lab from Bangladesh. He is estimating the causal effects of Right-Wing Authoritarianism and Social Dominance Orientation on a range of prejudice outcomes.
...
- **Zahle Stewart**: *Does Employer Gratitude Improve Employee Well-being?* — Using New Zealand Attitudes and Values Study data to examine causal effects of workplace appreciation on employee outcomes. [Slides (PDF)](https://www.dropbox.com/scl/fi/humnzsgo5blg7rrtvz3dt/Employer-Gratitude-and-Employee-Well-being.pdf?rlkey=oc4esqaip1loeaf7zt6eodx7n&dl=0)
...
![Zahle Stewart presenting her research](images/news/2025-sasp-melbourne/zahle-presenting.png){group="sasp2025"}
...
- **[2025 August 10-13]:** Workshop on Causal Inference at the University of California, San Diego [link](https://go-bayes.github.io/sparcc-day-2/)
